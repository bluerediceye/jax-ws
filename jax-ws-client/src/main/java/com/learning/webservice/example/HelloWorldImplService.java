 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://example.webservice.learning.com/", wsdlLocation = "http://localhost:8080/ws/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://example.webservice.learning.com/", "HelloWorldImplService");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://example.webservice.learning.com/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://example.webservice.learning.com/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
