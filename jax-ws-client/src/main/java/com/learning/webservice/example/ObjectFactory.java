 ...
 * generated in the com.learning.webservice.example package. 
...
public class ObjectFactory {
    ...
    private final static QName _HelloWorld_QNAME = new QName("http://example.webservice.learning.com/", "helloWorld");
    private final static QName _HelloWorldResponse_QNAME = new QName("http://example.webservice.learning.com/", "helloWorldResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.learning.webservice.example
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://example.webservice.learning.com/", name = "helloWorld")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://example.webservice.learning.com/", name = "helloWorldResponse")
